              ...
              routes: [
                {
                  ...
                  component: './orgnization/index',
                },
                {
                  name: 'new',
                  path: '/orgnization/new',
                  component: './orgnization/new',
                },
                {
                  name: 'detail',
                  hideInMenu: true,
                  path: '/orgnization/detail/:id?',
                  component: './orgnization/detail',
                },
                {
                  name: 'edit',
                  hideInMenu: true,
                  path: '/orgnization/edit/:id?',
                  component: './orgnization/edit',
                },
              ],
            },
            {
              ...
              routes: [{
                ...
                routes: [{
                  ...
                  component: './teacher/project/index',
                },{
                  name: 'new',
                  path: '/teacher/project/new',
                  component: './teacher/project/new',
                }, {
                  name: 'detail',
                  hideInMenu: true,
                  path: '/teacher/project/detail/:id?',
                  component: './teacher/project/detail',
                },
                {
                  name: 'edit',
                  hideInMenu: true,
                  path: '/teacher/project/:id?',
                  component: './teacher/project/edit',
                }]
              },{
                name: 'class',
                path: '/teacher/class',
                routes: [{
                  ...
                  component: './teacher/class/index',
                },{
                  name: 'new',
                  path: '/teacher/class/new',
                  component: './teacher/class/new',
                }, {
                  name: 'detail',
                  hideInMenu: true,
                  path: '/teacher/class/detail/:id?',
                  component: './teacher/class/detail',
                },
                {
                  name: 'edit',
                  hideInMenu: true,
                ...
                routes: [{
                  ...
                  component: './teacher/student/index',
                },{
                  name: 'new',
                  path: '/teacher/student/new',
                  component: './teacher/student/new',
                }, {
                  name: 'detail',
                  hideInMenu: true,
                  path: '/teacher/student/detail/:id?',
                  component: './teacher/student/detail',
                },
                {
                  name: 'edit',
                  hideInMenu: true,
                  path: '/teacher/student/edit/:id?',
                  component: './teacher/student//edit',
                }]
              }]
            },
            {
            ...
            },
            {
              ...
              routes: [{
                ...
                routes: [{
                  ...
                  component: './operate/banner/index',
                },{
                  name: 'new',
                  path: '/operate/banner/new',
                  component: './operate/banner/new',
                }]
              },{
                name: 'pc',
                path: '/operate/pc',
                routes: [{
                  ...
                  hideInMenu: true,
                  component: './operate/pc/index',
                },{
                  name: 'new',
                  path: '/operate/pc/new',
                  hideInMenu: true,
                  component: './operate/pc/new',
                }]
              }]
            },
            {
